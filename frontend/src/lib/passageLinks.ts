 ...
 * ```
 */
export function createPassageLink(params: PassageLinkParams, baseUrl?: string): string {
...
export function formatPassageReference(params: PassageLinkParams): string {
  ...
  if (params.verseStart !== undefined) {
    ...
    if (params.verseEnd !== undefined && params.verseEnd !== params.verseStart) {
 ...
 * ```
 */
export function parsePassageReference(reference: string): PassageLinkParams | null {
